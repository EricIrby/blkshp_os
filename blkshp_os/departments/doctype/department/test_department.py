...
class TestDepartment(FrappeTestCase):
    ...
    def test_department_code_is_unique_per_company(self) -> None:
        ...
        self._create_department(
            code="KIT-A", name="Kitchen Other", company=other_company
        )
    ...
    def test_get_department_setting_helper(self) -> None:
        ...
        self.assertEqual(
            get_department_setting(department.name, "default_ordering_day"), "monday"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            get_department_setting(department.name, "missing_key", "fallback"),
            "fallback",
        )
