...
class TestRecipe(FrappeTestCase):
    ...
    def test_department_company_alignment_is_enforced(self) -> None:
        ...
        other_department = self._ensure_department(
            "Recipe Alt Department", company=other_company
        )
    ...
    def test_product_ingredient_must_match_department(self) -> None:
        ...
        misaligned_product = self._ensure_product(
            "Recipe Alt Product 2", other_department
        )
    ...
    def test_allergens_inherit_from_subrecipes(self) -> None:
        ...
        output_product = self._ensure_product(
            "Allergen Output Product", self.department
        )
    ...
    def _ensure_product(
        self, name: str, department: str, *, company: str | None = None
    ) -> str:
