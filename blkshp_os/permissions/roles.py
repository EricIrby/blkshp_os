...
def get_permissions_by_category(user: str | None = None) -> dict[str, list[dict[str, Any]]]:
	...
	# Group by category
	by_category: dict[str, list[dict[str, Any]]] = {cat: [] for cat in PERMISSION_CATEGORIES}
...
def get_role_summary(role: str) -> dict[str, Any]:
	...
	return {
		"role": role,
		"description": role_doc.role_description if hasattr(role_doc, "role_description") else "",
		"is_custom": role_doc.is_custom_role if hasattr(role_doc, "is_custom_role") else False,
